// Proof that deletePick / deleteParlayBet scope their delete by id + userId
// ONLY - never a name or any other text match. This is the standing project
// rule after a text-`where` deleteMany once ran against production (see the
// delete-queries-must-filter-by-id-only note). Also checks the not-found
// path throws rather than silently succeeding.
//
