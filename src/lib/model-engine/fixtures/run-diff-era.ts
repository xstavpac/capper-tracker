...
// runs, pitcher_era in earned-run average), a longer calculation chain
...
export const runDiffEraModel: ModelDefinition = {
  ...
  dataInputs: [
    ...
    {
      id: "di_pitcher_era",
      variableId: "pitcher_era",
      entity: { type: "pitcher", role: "favorite" },
      params: {},
      sourceRef: null,
    },
  ],
  ...
  calculations: [
    ...
    { id: "calc_era_penalty", expression: { op: "multiply", left: { ref: "di_pitcher_era" }, right: { literal: -1 } } },
    {
      id: "calc_combined",
  ...
  conditions: [
    ...
    {
      id: "cond_era_low",
      when: { op: "lessThan", left: { ref: "di_pitcher_era" }, right: { literal: 3.5 } },
    },
  ...
  metadata: {
    description: "Run differential adjusted for opposing starter ERA - a second, unrelated configuration through the same engine.",
    createdAt: "2026-08-13T00:00:00.000Z",
    updatedAt: "2026-08-13T00:00:00.000Z",
    createdBy: "acceptance-test",
    tags: ["team_stats", "pitcher_stats"],
    ownerRef: null,
    sourceRefs: [],
  },
};
