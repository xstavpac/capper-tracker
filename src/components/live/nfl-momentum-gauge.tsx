...
function needleColorFor(classification: NflMomentumClassification): string {
...
function Dial({ netShift, classification }: { netShift: number; classification: NflMomentumClassification }) {
